    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden md:flex items-center space-x-8">
              ...
              <Link to="/contact" className="text-restaurant-gold font-medium">
                Contact
              </Link>
      ...
      <div className="container mx-auto px-4 py-20">
        <div className="max-w-2xl mx-auto text-center">
          <h2 className="text-4xl font-bold text-restaurant-brown mb-6">Contact Us</h2>
          <div className="bg-restaurant-cream rounded-lg p-12 mb-8">
            <ChefHat className="h-16 w-16 text-restaurant-gold mx-auto mb-6" />
            <h3 className="text-2xl font-bold text-restaurant-brown mb-4">Get In Touch</h3>
            <p className="text-restaurant-brown/80 mb-6">
              We're working on a comprehensive contact page with a detailed contact form, 
              location map, and all the information you need to reach us or visit our restaurant.
            </p>
            <p className="text-sm text-restaurant-brown/60 mb-8">
              In the meantime, you can find our contact information and reservation form on the homepage.
            </p>
